...
class AdditionalLibsAction(workflows.Action):
    ...
    class Meta(object):
        name = _("Libs")
        help_text_template = "job_templates/_create_job_libs_help.html"
    ...
    main_binary = forms.DynamicChoiceField(
        ...
        widget=fields.DynamicSelectWidget(
            attrs={
                ...
                'data-jobtype-storm.pyleus': _("Choose a main binary"),
...
class ConfigureArguments(workflows.Step):
    ...
    template_name = "job_templates/job_interface_arguments_template.html"
...
class ConfigureLibs(workflows.Step):
    ...
    template_name = "job_templates/library_template.html"
